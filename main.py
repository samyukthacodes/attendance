...
class App:
    def __init__(self):
        ...
        self.register_new_user_button_main_window = util.get_button(self.main_window, 'register', 'grey', self.register_new_user, fg = 'black')
    ...
    def login(self):
        ...
        if name in ['no_persons_found', 'unknown_user']:
            ...
            util.msg_box('Welcome', '{}, your attendance has been marked'.format(name))
